...
pip-compile --emit-index-url --header --emit-trusted-host -qo .misc/requirements/prod.txt .misc/requirements/base.in .misc/requirements/prod.in .misc/requirements/test.in
